...
RUN echo 'Downloading linux.x64_11gR2_database_1of2.zip' && \
    wget --no-check-certificate -q -O /root/p13390677_112040_Linux-x86-64_1of7.zip http://file.matmagoc.com/oracle/p13390677_112040_Linux-x86-64_1of7.zip && \
    echo 'Downloading linux.x64_11gR2_database_2of2.zip' && \
    wget --no-check-certificate -q -O /root/p13390677_112040_Linux-x86-64_2of7.zip http://file.matmagoc.com/oracle/p13390677_112040_Linux-x86-64_2of7.zip
